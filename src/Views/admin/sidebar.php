...
<aside class="w-64 bg-[#062B41] text-white flex flex-col min-h-screen">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        <a href="/admin/blocked-dates" class="flex items-center py-2 px-4 rounded hover:bg-white hover:text-black transition-colors font-semibold text-base">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php if ($role === 'superadmin'): ?>
            <a href="/admin/audit-logs" class="flex items-center py-2 px-4 rounded hover:bg-white hover:text-black transition-colors font-semibold text-base">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6M7 4h7l3 3v13a1 1 0 01-1 1H7a1 1 0 01-1-1V5a1 1 0 011-1z"></path>
                </svg>
                Audit Logs
            </a>
        <?php endif; ?>
